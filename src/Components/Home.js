...
const Home = () => {
  return (
    <div className="flex flex-col w-full lg:w-5/6 mx-auto py-8 px-4 lg:px-0">
      <div className="bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 p-8 rounded-lg shadow-md text-white mb-12">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-lg font-medium text-gray-800">
          <div className="flex flex-col items-center justify-center space-y-4">
            <div className="w-16 h-16 bg-blue-600 p-4 rounded-full flex items-center justify-center text-white">
